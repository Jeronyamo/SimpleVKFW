...
//  ============  Vulkan Instance  ============  \\
    ...
    namespace Instance {
        ...
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkInstanceCreateFlags _flags = 0u,
                                   const VkAllocationCallbacks * _create_cb = nullptr) {
                return { (ObjectHandleType) make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_INSTANCE };
            }
            ...
            VkInstance make(void *_p_next = nullptr, VkInstanceCreateFlags _flags = 0u,
                ...
                if (vkCreateInstance(&__info, _create_cb, &_instance) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Instance Builder :: make", "could not create instance"));

                if (volk_load_inst_only) {
                     volkLoadInstanceOnly(_instance);
                     printf(SVKFW_WRAPINFO(" Instance Builder :: make", "only instance-based function pointers are loaded. Call volkLoadDevice() after VkDevice creation.\n"));
                }
...
//  ============  Vulkan Debug Messenger Callback  ============  \\
    ...
    namespace DebugUtilsMessengerEXT {
        ...
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkDebugUtilsMessengerCreateFlagsEXT _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_DEBUG_UTILS_MESSENGER_EXT };
            }
            ...
            VkDebugUtilsMessengerEXT make(void *_p_next = nullptr, VkDebugUtilsMessengerCreateFlagsEXT _flags = 0u,
                ...
                if (vkCreateDebugUtilsMessengerEXT(instance, &__info, _create_cb, &_messenger) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" DebugMessenger Builder :: make","could not create debug messenger"));
...
//  ============  Vulkan Logical Device  ============  \\
    ...
    // Classes definition
        ...
        // Clear state:
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkDeviceCreateFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_DEVICE };
            }

            VkDevice make(void *_p_next = nullptr, VkDeviceCreateFlags _flags = 0u,
                          const VkAllocationCallbacks * _create_cb = nullptr) {
                if (phys_device == VK_NULL_HANDLE)
                    throw std::logic_error(SVKFW_WRAPERR(" Device Builder :: make", "physical device handle was not set"));
                ...
                if (vkCreateDevice(phys_device, &__info, _create_cb, &__device) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Device Builder :: make","could not create device"));
                return __device;
            }
...
//  ============  Vulkan Surface  ============  \\
    ...
    namespace SurfaceKHR {
        struct Builder { // Although GLFW covers all portability, TODO: add "canonical" Builder for VkSurfaceKHR
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_SURFACE_KHR };
            }
            ...
            VkSurfaceKHR make(void *_p_next = nullptr, VkFlags _flags = 0u, // these two parameters are not used
                ...
                if (glfwCreateWindowSurface(instance, glfw_window, _create_cb, &__surface) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Surface Builder :: make","could not create surface"));
                return __surface;
            }
    ...
    namespace SwapchainKHR {
        ...
        struct Builder {
            ...
            void initHandler(Handler &_handle, void *_p_next = nullptr, VkSwapchainCreateFlagsKHR _flags = 0u,
                ...
                _handle.handler = make(_p_next, _flags, _create_cb);
            }

            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkSwapchainCreateFlagsKHR _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_SWAPCHAIN_KHR };
            }
            ...
            VkSwapchainKHR make(void *_p_next = nullptr, VkSwapchainCreateFlagsKHR _flags = 0u,
                ...
                if (vkCreateSwapchainKHR(device, &__info, _create_cb, &__swapchain) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Swapchain Builder :: make","could not create swapchain"));
                return __swapchain;
            }
...
//  ============  Vulkan Image View  ============  \\
    ...
    namespace ImageView {
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkImageViewCreateFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_IMAGE_VIEW };
            }
            ...
            VkImageView make(void *_p_next = nullptr, VkImageViewCreateFlags _flags = 0u,
                ...
                if (vkCreateImageView(device, &__info, _create_cb, &__image_view) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Image View Builder :: make",
...
//  ============  Vulkan Shader Module  ============  \\
    ...
    namespace ShaderModule {
        ...
        // Clear state:
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkShaderModuleCreateFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_SHADER_MODULE };
            }
            ...
            VkShaderModule make(void *_p_next = nullptr, VkShaderModuleCreateFlags _flags = 0u,
                ...
                if (vkCreateShaderModule(device, &__info, _create_cb, &__shader) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Shader Module Builder :: make",
...
//  ============  Vulkan Render Pass  ============  \\
    ...
    namespace RenderPass {
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkRenderPassCreateFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_RENDER_PASS };
            }
            ...
            VkRenderPass make(void *_p_next = nullptr, VkRenderPassCreateFlags _flags = 0u,
                ...
                if (vkCreateRenderPass(device, &__info, _create_cb, &__render_pass) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Render Pass Builder :: make",
...
//  ============  Vulkan Pipeline Layout  ============  \\
    ...
    namespace PipelineLayout {
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkPipelineLayoutCreateFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_PIPELINE_LAYOUT };
            }
            ...
            VkPipelineLayout make(void *_p_next = nullptr, VkPipelineLayoutCreateFlags _flags = 0u,
                ...
                if (vkCreatePipelineLayout(device, &__info, _create_cb, &__layout) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Pipeline Layout Builder :: make", "could not create pipeline layout"));
...
//  ============  Vulkan Graphics Pipeline  ============  \\
        ...
        namespace Graphics {
            struct Builder {
                ...
                ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkPipelineCreateFlags _flags = 0u,
                                              const VkAllocationCallbacks * _create_cb = nullptr) {
                    return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_PIPELINE };
                }
                ...
                VkPipeline make(void *_p_next = nullptr, VkPipelineCreateFlags _flags = 0u,
                    ...
                    if (vkCreateGraphicsPipelines(device, pipeline_cache, 1, &__info, _create_cb, &__pipeline) != VK_SUCCESS)
                        throw std::runtime_error(SVKFW_WRAPERR(" Graphics Pipeline :: make", "failed to create graphics pipeline"));
            ...
            struct Builder {
                ...
                VkPipeline make(void *_p_next = nullptr, VkPipelineCreateFlags _flags = 0u,
                    ...
                    if (vkCreateComputePipelines(device, pipeline_cache, 1, &__info, _create_cb, &__pipeline) != VK_SUCCESS)
                        throw std::runtime_error(SVKFW_WRAPERR(" Compute Pipeline :: make", "failed to create compute pipeline"));
...
//  ============  Vulkan Framebuffer  ============  \\
    ...
    namespace Framebuffer {
        ...
        // Clear state:
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkFramebufferCreateFlags _flags = 0u,
                                            const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_FRAMEBUFFER };
            }
            ...
            VkFramebuffer make(void *_p_next = nullptr, VkFramebufferCreateFlags _flags = 0u,
                ...
                if (vkCreateFramebuffer(device, &__info, _create_cb, &__framebuffer) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Framebuffer :: make", "failed to create framebuffer"));
...
// ============  Vulkan Command Pool  ============  \\
    ...
    namespace CommandPool {
        ...
        // Clear state:
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkCommandPoolCreateFlags _flags = 0u,
                                            const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_COMMAND_POOL };
            }
            ...
            VkCommandPool make(void *_p_next = nullptr, VkCommandPoolCreateFlags _flags = 0u,
                ...
                if (vkCreateCommandPool(device, &__info, _create_cb, &__framebuffer) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Command Pool :: make", "failed to create command pool"));
    ...
    namespace CommandBuffer {
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkFlags _flags = 0u,
                                          const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next), VK_OBJECT_TYPE_COMMAND_BUFFER };
            }

            VkCommandBuffer make(void *_p_next = nullptr, VkFlags _flags = 0u,
                                 const VkAllocationCallbacks * _create_cb = nullptr) {
                ...
                if (vkAllocateCommandBuffers(device, &__info, &__command_buffer) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Command Buffer :: make", "failed to allocate command buffer"));
...
//  ============  Vulkan syncronization  ============  \\
    ...
    namespace Semaphore {
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkSemaphoreCreateFlags _flags = 0u,
                                            const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_SEMAPHORE };
            }
            ...
            VkSemaphore make(void *_p_next = nullptr, VkSemaphoreCreateFlags _flags = 0u,
                ...
                if (vkCreateSemaphore(device, &__info, _create_cb, &__semaphore) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Semaphore :: make", "failed to create semaphore"));
    ...
    namespace Fence {
        struct Builder {
            ...
            ObjectInfoType makeInfoObject(void *_p_next = nullptr, VkFenceCreateFlags _flags = 0u,
                                            const VkAllocationCallbacks * _create_cb = nullptr) {
                return { make(_p_next, _flags, _create_cb), VK_OBJECT_TYPE_FENCE };
            }
            ...
            VkFence make(void *_p_next = nullptr, VkFenceCreateFlags _flags = 0u,
                ...
                if (vkCreateFence(device, &__info, _create_cb, &__fence) != VK_SUCCESS)
                    throw std::runtime_error(SVKFW_WRAPERR(" Fence :: make", "failed to create fence"));
